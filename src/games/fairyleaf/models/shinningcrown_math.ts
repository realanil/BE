...
export class ShinningCrownMath extends PlatformMath {
    ...
    constructor() {
        ...
        this.paidReels = [{
            id: "b1", weight: 4,
            reels: [
                [1, 7, 5, 9, 6, 7, 4, 5, 3, 6, 2, 8, 7, 4, 5, 5, 5, 11, 11, 2, 6, 4, 7, 7, 7, 2, 4, 9, 6, 6, 7, 8, 4, 5, 5, 5, 11, 11, 8, 5, 7, 11, 11, 6, 6, 6, 4, 8, 2, 9, 3, 8, 8, 8, 5, 1, 6, 6, 6, 4, 7, 7, 7, 3, 4, 11, 11, 8, 5, 6, 8, 5, 6, 8, 7, 4, 11, 11, 7, 7, 1, 3, 4, 8, 5, 8, 8, 8, 3, 2],
                ...
                [3, 6, 6, 6, 11, 11, 2, 3, 4, 9, 8, 7, 5, 5, 7, 2, 3, 2, 3, 11, 11, 7, 7, 7, 4, 2, 0, 4, 2, 6, 1, 5, 3, 8, 8, 5, 0, 8, 5, 5, 1, 6, 6, 6, 11, 11, 4, 3, 2, 3, 2, 8, 8, 8, 7, 11, 11, 3, 6, 2, 7, 5, 2, 5, 2, 7, 7, 7, 8, 6, 3, 0, 6, 3, 8, 4, 3, 2, 5, 5, 9, 3, 2, 1, 8, 11, 11],
                ...
                [1, 7, 3, 4, 7, 5, 5, 5, 2, 3, 6, 6, 6, 3, 4, 2, 11, 11, 5, 5, 5, 3, 11, 11, 5, 8, 8, 8, 2, 8, 4, 6, 11, 11, 3, 2, 7, 4, 6, 3, 8, 4, 5, 6, 6, 6, 4, 3, 9, 3, 7, 7, 7, 11, 11, 3, 1, 8, 4, 3, 5, 7, 7, 7, 9, 8, 8, 8, 2, 6, 10]
            ]
        }, {
            id: "b2", weight: 6,
            reels: [
                [1, 7, 5, 9, 6, 7, 4, 5, 3, 6, 2, 8, 7, 4, 5, 5, 5, 2, 6, 4, 7, 7, 7, 2, 4, 9, 6, 6, 7, 8, 4, 5, 5, 5, 8, 7, 5, 6, 6, 6, 4, 8, 2, 9, 3, 8, 8, 8, 5, 1, 6, 6, 6, 4, 7, 7, 7, 3, 4, 8, 5, 6, 8, 5, 6, 8, 4, 7, 7, 7, 1, 3, 4, 8, 5, 8, 8, 8, 3, 2],
                ...
                [3, 6, 6, 6, 2, 3, 4, 9, 8, 7, 7, 5, 5, 2, 3, 2, 3, 7, 7, 7, 4, 4, 2, 2, 6, 1, 5, 3, 8, 8, 8, 5, 5, 5, 1, 6, 6, 6, 4, 3, 2, 3, 2, 8, 8, 8, 7, 3, 6, 2, 7, 5, 2, 5, 2, 7, 7, 7, 8, 6, 6, 3, 3, 8, 4, 3, 2, 5, 5, 9, 3, 2, 1, 8],
                ...
                [1, 7, 3, 4, 7, 5, 5, 5, 2, 3, 6, 6, 6, 3, 4, 2, 5, 5, 5, 3, 5, 8, 8, 8, 2, 8, 4, 6, 3, 2, 7, 4, 6, 3, 8, 4, 5, 6, 6, 6, 4, 3, 9, 3, 7, 7, 7, 3, 1, 8, 4, 3, 5, 7, 7, 7, 9, 8, 8, 8, 2, 6, 10]
            ]
        }];
