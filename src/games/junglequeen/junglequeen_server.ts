...
import { JungleQueenConfigResponseV2Model, JungleQueenResponseModel } from "./models/junglequeen_response";
...
export class GameServer extends BaseSlotGame {
    ...
    protected getConfigResponse( response:PlayResponseModel):ResponseModel {
        return new JungleQueenConfigResponseV2Model( this.version, this.name, this.math, this.state  as JungleQueenState);
    }
